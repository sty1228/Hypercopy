                ...
                <div>
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${parsedAmount > availableBalance ? "rgba(239,68,68,0.4)" : "rgba(255,255,255,0.08)"}`,
                    }}
                  >
            ...
            {step === "success" && (
              <div className="py-8 flex flex-col items-center text-center">
                ...
                <p className="text-[11px] text-gray-400 mb-1">
                  ${parsedAmount.toFixed(2)} USDC will arrive in your Arbitrum wallet
                </p>
                <div
                ...
                <button
                  ...
                  style={{ background: "rgba(168,85,247,1)", color: "#ffffff" }}
                >
                  Done
                </button>
              </div>
