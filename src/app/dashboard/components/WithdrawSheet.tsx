    ...
    <>
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, #111820 0%, #0a0f14 100%)",
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {effectiveMaxRounded > 0 && (
                    <button
                      onClick={() =>
                        setAmount(effectiveMaxRounded.toString())
                      }
                ...
                >
                  ...
                  <p className="text-[10px] text-gray-400 leading-relaxed">
                    ...
                    and sent directly to your connected Arbitrum wallet.
            ...
            {step === "processing" && (
              <div className="py-8 flex flex-col items-center text-center">
                ...
                <p className="text-[11px] text-gray-400 max-w-[240px]">
                  Withdrawing from HyperLiquid and sending USDC to your
                  Arbitrum wallet. This may take a few minutes.
                </p>
              </div>
            )}
            ...
            {step === "success" && (
              <div className="py-8 flex flex-col items-center text-center">
                ...
                <p className="text-[11px] text-gray-400 mb-1">
                  ${parsedAmount.toFixed(2)} USDC on its way to your wallet
                </p>
                <div
